...
public class AndroidXmlParser {
	...
	public static void main(String[] args) {
		new AndroidXmlParser().getIntents("/home/syed/Downloads/UniversalAndroot-1.6.2-beta5.apk");
	}
			...
			if (tag0 == startTag) { // XML START TAG
				...
				for (int ii=0; ii<numbAttrs; ii++) {
					...
					String attrValue = attrValueSi!=-1
							...
							if(name.equalsIgnoreCase("manifest") && attrName.equalsIgnoreCase("package")){
								return attrValue;
							}
