...
public class SWTImageCanvas extends Canvas {
	...
	public SWTImageCanvas(final Composite parent, boolean scrollVisible) {
		this(parent, SWT.NULL,scrollVisible);
	}
	 ...
	 */
	public SWTImageCanvas(final Composite parent, int style, boolean scrollVisible) {
		super( parent, style|SWT.BORDER_SOLID|SWT.V_SCROLL|SWT.H_SCROLL
				| SWT.NO_BACKGROUND);
	...
	public void onFileOpen() {
		...
		fileChooser.setFilterNames(
				new String[] { "SWT image" + " ( jpeg, png, ico, bmp)" });
